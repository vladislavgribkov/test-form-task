...
export type AllApplicantIndividualCompanyRelationsQueryVariables = Exact<{ [key: string]: never }>;

export type AllApplicantIndividualCompanyRelationsQuery = {
  __typename?: 'Query';
...
export type AllApplicantIndividualCompanyPositionsQueryVariables = Exact<{ [key: string]: never }>;

export type AllApplicantIndividualCompanyPositionsQuery = {
  __typename?: 'Query';
...
export const AllApplicantIndividualCompanyRelationsDocument = gql`
  query allApplicantIndividualCompanyRelations {
    applicantIndividualCompanyRelations {
      data {
        id
        name
...
/**
 * __useAllApplicantIndividualCompanyRelationsQuery__
 *
 * To run a query within a React component, call `useAllApplicantIndividualCompanyRelationsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllApplicantIndividualCompanyRelationsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllApplicantIndividualCompanyRelationsQuery({
 *   variables: {
 *   },
 * });
 */
export function useAllApplicantIndividualCompanyRelationsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    AllApplicantIndividualCompanyRelationsQuery,
    AllApplicantIndividualCompanyRelationsQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    AllApplicantIndividualCompanyRelationsQuery,
    AllApplicantIndividualCompanyRelationsQueryVariables
  >(AllApplicantIndividualCompanyRelationsDocument, options);
}
export function useAllApplicantIndividualCompanyRelationsLazyQuery(
...
export type AllApplicantIndividualCompanyRelationsQueryHookResult = ReturnType<
  typeof useAllApplicantIndividualCompanyRelationsQuery
>;
export type AllApplicantIndividualCompanyRelationsLazyQueryHookResult = ReturnType<
  typeof useAllApplicantIndividualCompanyRelationsLazyQuery
>;
export type AllApplicantIndividualCompanyRelationsQueryResult = Apollo.QueryResult<
  AllApplicantIndividualCompanyRelationsQuery,
  AllApplicantIndividualCompanyRelationsQueryVariables
>;
export const AllApplicantIndividualCompanyPositionsDocument = gql`
  query allApplicantIndividualCompanyPositions {
    applicantIndividualCompanyPositions {
      data {
        id
        name
...
/**
 * __useAllApplicantIndividualCompanyPositionsQuery__
 *
 * To run a query within a React component, call `useAllApplicantIndividualCompanyPositionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllApplicantIndividualCompanyPositionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllApplicantIndividualCompanyPositionsQuery({
 *   variables: {
 *   },
 * });
 */
export function useAllApplicantIndividualCompanyPositionsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    AllApplicantIndividualCompanyPositionsQuery,
    AllApplicantIndividualCompanyPositionsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    AllApplicantIndividualCompanyPositionsQuery,
    AllApplicantIndividualCompanyPositionsQueryVariables
  >(AllApplicantIndividualCompanyPositionsDocument, options);
}
export function useAllApplicantIndividualCompanyPositionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    AllApplicantIndividualCompanyPositionsQuery,
    AllApplicantIndividualCompanyPositionsQueryVariables
  >
...
export type AllApplicantIndividualCompanyPositionsQueryHookResult = ReturnType<
  typeof useAllApplicantIndividualCompanyPositionsQuery
>;
export type AllApplicantIndividualCompanyPositionsLazyQueryHookResult = ReturnType<
  typeof useAllApplicantIndividualCompanyPositionsLazyQuery
>;
export type AllApplicantIndividualCompanyPositionsQueryResult = Apollo.QueryResult<
  AllApplicantIndividualCompanyPositionsQuery,
  AllApplicantIndividualCompanyPositionsQueryVariables
>;
